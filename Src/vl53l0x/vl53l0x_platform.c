...
int _I2CWrite(VL53L0X_DEV Dev, uint8_t *pdata, uint32_t count) {
    ...
    status = HAL_I2C_Master_Transmit(Dev->hi2c, Dev->I2cDevAddr, pdata, count, i2c_time_out);
...
int _I2CRead(VL53L0X_DEV Dev, uint8_t *pdata, uint32_t count) {
    ...
    status = HAL_I2C_Master_Receive(Dev->hi2c, Dev->I2cDevAddr|1, pdata, count, i2c_time_out);
